        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="table.html"><?php echo 'Welcome, ' . $first_name ?></a>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                ...
                                <p class="category">Listed are all customers who have a membership with us to park at our garages</p>
                            </div>
